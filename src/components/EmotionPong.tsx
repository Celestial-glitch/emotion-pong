...
const EmotionPong: React.FC<EmotionPongProps> = ({ detectedEmotion = "neutral" }) => {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      if (detectedEmotion === "happy" && paddleX + paddleWidth < canvasSize.width) {
  ...
  }, [detectedEmotion, paddleX, ball, isGameOver, isPaused, gameStarted, playSound, score, highScore, canvasSize, paddleWidth, paddleY, paddleSpeed]);
  ...
  if (isGameOver) {
    ...
    return (
      <div className="position-fixed top-0 start-0 w-100 h-100 d-flex flex-column align-items-center justify-content-center" style={{
        ...
        <div className="bg-dark bg-opacity-75 p-4 rounded text-center mb-4" style={{
          ...
          <div className="row g-3 mb-3">
            ...
            <div className="col-4">
              <div className="h5 text-light">{highScore.toString().padStart(4, '0')}</div>
              <div className="small text-muted">BEST</div>
            </div>
            <div className="col-4">
              <div className="h5 text-light">{Math.round((score / gameTime) * 60) || 0}</div>
  ...
  return (
    <div className="d-flex flex-column align-items-center w-100" style={{
      ...
      {gameStarted && (
        <>
          <div className="d-flex justify-content-between w-100 mb-3 p-3 bg-dark bg-opacity-50 rounded" style={{
            ...
            <div className="text-center flex-fill">
              ...
              <div className="h5 text-light">{score.toString().padStart(4, '0')}</div>
            </div>
            <div className="text-center flex-fill">
